...
def read_competition_rows(xlsx_path: str, competition_name: str) -> list[dict]:
    wb = openpyxl.load_workbook(xlsx_path, data_only=True)
    ws = wb["StatisticDownload_20260506_1319"] if "StatisticDownload_20260506_1319" in wb.sheetnames else wb[wb.sheetnames[0]]
...
def main():
    ...
    ap.add_argument("--competition", default=COMPETITION_NAME)
    args = ap.parse_args()
    ...
    raw_rows = read_competition_rows(args.xlsx, args.competition)
    if args.only:
