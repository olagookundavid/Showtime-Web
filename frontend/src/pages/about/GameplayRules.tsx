    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="bg-sffl-navy text-white p-8 rounded-2xl shadow-xl">
                <h1 className="text-4xl font-black italic">GAMEPLAY RULES</h1>
            ...
            <section className="bg-white p-8 rounded-xl shadow-md space-y-6">
                ...
                <h2 className="text-2xl font-bold text-sffl-navy">Quick Reference</h2>

                <div className="space-y-4">
                    <div className="border-l-4 border-sffl-red pl-4">
                        <h3 className="font-bold text-lg text-sffl-navy">Team Composition</h3>
                    ...
                    <div className="border-l-4 border-sffl-red pl-4">
                        <h3 className="font-bold text-lg text-sffl-navy">Game Duration</h3>
                        <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-sffl-red pl-4">
                        <h3 className="font-bold text-lg text-sffl-navy">Scoring</h3>
                    ...
                    <div className="border-l-4 border-sffl-red pl-4">
                        <h3 className="font-bold text-lg text-sffl-navy">Flag Pulling</h3>
                        <p className="text-gray-700">
                    ...
                    <div className="border-l-4 border-sffl-red pl-4">
                        <h3 className="font-bold text-lg text-sffl-navy">No Contact Rule</h3>
                        <p className="text-gray-700">
