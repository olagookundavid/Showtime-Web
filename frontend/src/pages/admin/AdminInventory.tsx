...
export const AdminInventory = () => {
    ...
    return (
        <div className="space-y-6 relative">
            <h1 className="text-3xl font-black text-sffl-navy dark:text-white">Inventory Management</h1>
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-red-700">
                                <ul className="list-disc pl-5 space-y-1">
                                    {lowStock.map(p => (
                                        <li key={p.id}>
                                            <span className="font-semibold">{p.name}</span> is below threshold! Quantity: {p.quantity} / {p.threshold}
                                        </li>
                                    ))}
                                </ul>
                            </div>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                        <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                            ...
                            <button onClick={handleCloseForm} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors">
                        ...
                        <form onSubmit={handleSaveProduct} className="p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-2 pt-2">
                                ...
                                <label htmlFor="is_active" className="text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Active Product (Visible for sale)
                                </label>
                            </div>
