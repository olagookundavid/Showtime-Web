...
const AdminTeams = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Manager Modal */}
            {managerModal && (
                <div className="fixed inset-0 z-[100] bg-black/70 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 overflow-hidden" data-dialog onClick={() => setManagerModal(null)}>
