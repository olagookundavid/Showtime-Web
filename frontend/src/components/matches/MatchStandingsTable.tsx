                        ...
                        {standings.map((standing, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-1 py-2 md:px-4 md:py-4 font-semibold text-sffl-navy dark:text-white flex justify-center items-center gap-1">
                                        <LightboxImage 
                                        ...
                                        />
                                        {isGold && <span title="Champion" className="text-xs">👑</span>}
                                        {isSilver && <span title="Runner Up" className="text-xs">🥈</span>}
                                    </td>
