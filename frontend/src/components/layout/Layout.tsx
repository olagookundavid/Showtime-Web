...
export const Layout = () => {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen w-full max-w-[100vw] transition-colors duration-500 bg-transparent overscroll-y-none`}
    >
      ...
      <main className="grow w-full max-w-page mx-auto px-2 sm:px-6 lg:px-8 py-3 md:py-8 pb-[calc(9rem+2*env(safe-area-inset-bottom,0px))] lg:pb-8 relative z-10 overscroll-y-none">
        <Outlet />
      </main>
      ...
      <BottomNav
        onMoreClick={() => setIsMoreMenuOpen((prev) => !prev)}
            ...
            <div className="w-1/2 p-5 sm:p-6 overflow-y-auto overscroll-contain pb-[calc(9rem+2*env(safe-area-inset-bottom,0px))]">
              ...
              <div className="mb-5">
                <div className="flex items-center justify-between mb-2 px-1">
                  ...
                  <span className="text-[10px] font-bold text-sffl-red uppercase">
                    SFFL 2026
                  </span>
                </div>
